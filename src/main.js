...
const SKILLS = [
  ...
  { name: 'VS Code', icon: '🖥️', level: 85 },
  { name: 'LeetCode', icon: '💻', level: 60 },
...
const PROJECTS = [
  {
    ...
    description: 'Developing a Library Management System using Java to manage book records and user details efficiently.',
    tags: ['Java', 'Ongoing'],
  ...
  },
  {
    ...
    description: 'Developed a web-based daily expense tracking application to manage and monitor daily spendings.',
